...
- Multi-tenant relay DEPLOYED: `oneflare-logpush-relay.acmecorp-lab.workers.dev` (KV REGISTRY
  `bdbe1493beaa4df4af83a1ed6647df9c`; secrets LAB_ENROLL_CODE=`soledrop-1JBZRujUMByb1LbA`,
  ADMIN_TOKEN=`44yn5b18VhO3idsL9un6vIaUevnXsID7QeGCmTNM7w8`). Auth to S1 HEC = `Authorization: Splunk <token>`.
